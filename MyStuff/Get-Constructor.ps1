Function Get-Constructor {
    ...
    Version 5 Poweshell has builtin function that returns list of constructors.
    [System.DateTime]::new # without the () shows function parameters
    [system.math] | gm -Static
        ...
        .EXAMPLE
            Get-Constructor -Type "system.datetime"
        ...
        .EXAMPLE
            [System.DateTime]  | Get-Constructor # Fred Added this
...
$object = New-Object PSobject -Property @{
                    Type = $fred[2].DeclaringType
                    Parameters = $Fred[2].GetParameters()
                }
                $object.pstypenames.insert(0,'System.Constructor')
                Write-Output $Object
...
System.DateTime.GetConstructors() | Select @{
		        Label="$($type.Name) Constructors"
		        Expression={($_.GetParameters() | ForEach {$_.ToString()}) -Join ", "}
