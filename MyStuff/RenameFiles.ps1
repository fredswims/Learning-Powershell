...
18 get-item fred*
  ...
  # Place "." after YYYY-MM-DD
  get-item 20* | rename-item -confirm -NewName {$_.name.insert($_.name.lastindexof("-")+3,".")}
  # Remove spaces
  get-item 2011* | rename-item -confirm -NewName {$_.name.replace(" ","")}