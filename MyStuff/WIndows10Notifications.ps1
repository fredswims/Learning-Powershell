# https://raw.githubusercontent.com/Windos/BurntToast/master/New-BurntToastNotification.ps1
...
function New-BurntToastNotification
{
    ...
    (
        ...
        # [String] $Image = ( Join-Path -Path $PSScriptRoot -ChildPath 'BurntToast.png' ),
           [String] $Image = "C:\Windows\WinSxS\amd64_microsoft-windows-printing-fdprint_31bf3856ad364e35_10.0.14393.0_none_85a47c329bf5760c",
